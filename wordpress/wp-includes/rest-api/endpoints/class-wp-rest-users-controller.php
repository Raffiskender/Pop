...
class WP_REST_Users_Controller extends WP_REST_Controller {
	...
	public function create_item_permissions_check( $request ) {
		...
		//* This function had been modified thus we can create a new user thought the Rest API
		//*(This solution was found on https://stackoverflow.com/questions/49649513/wordpress-rest-api-user-registration)
